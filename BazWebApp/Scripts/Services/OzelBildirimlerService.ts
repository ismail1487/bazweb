...
class OzelBildirimlerService extends kendo.data.ObservableObject {
    ...
    hedefkitleler: HedefKitleTanim[];
    roller: DropDownModel[];
    pozisyonlar: DropDownModel[];
    kurumlar: DropDownModel[];
    SecilenKisiler: number[];
    hedefKitleId: any;
    rolId: any;
    pozisyonId: any;
    kurumId: any;
    data = new OzelBildirimModel({
