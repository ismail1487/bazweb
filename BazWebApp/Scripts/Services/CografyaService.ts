...
class CografyaService extends kendo.data.ObservableObject {
    ...
    data = new CografyaListViewModel({
        CografyaTanim: "",
        CografyaAciklama: "",
    ...
    pageinfo: any;
    selectedSehirPageInfo: any;
    cografyaTable: any;
    sehirTable: any;
    seciliSehirTable: any;
    ulkelerList: DropDownModel[];

    sehirlistesi = [];
    selectedSehirList: Array<number> = [];
